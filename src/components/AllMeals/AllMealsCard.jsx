...
const AllMealsCard = ({ meal }) => {
    ...
    const shortDetails = foodDetails?.length > 70 
            ...
            <div className="card-body p-4 flex flex-col grow">
                <div className='grow space-y-2'>
                    <div className="flex justify-between items-start">
                        ...
                        <span className="text-[#f97416] font-bold">৳{foodPrice}</span>
                    </div>

                    <div className="flex flex-col gap-0.5 text-sm text-gray-600 dark:text-gray-400 font-sans">
                        <p className="font-medium">By {chefName} <span className="text-[10px] opacity-60">(Exp: {chefsExperience}y)</span></p>
                    ...
                    <div className="pt-2">
                        <span className='badge badge-outline border-[#f97416] text-[#f97416] text-xs font-bold uppercase tracking-wider'>
                            {deliveryArea}
                        </span>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="card-actions">
                        <Link
                            ...
                            className="btn btn-sm bg-[#f97416] hover:bg-[#d96412] text-white border-none rounded-md px-4"
                        >
                            Details
                        </Link>
                    </div>
