...
const AppPromo = () => {
    return (
        <section className="py-24 bg-base-100 overflow-hidden" style={{ fontFamily: '"Roboto Slab", serif' }}>
            <div className="max-w-6xl mx-auto px-4">
                <div className="bg-gradient-to-br from-orange-50 to-white dark:from-base-200 dark:to-base-100 rounded-[3rem] p-8 md:p-16 flex flex-col lg:flex-row items-center gap-16 border border-orange-100 dark:border-white/5 relative">
                    
                   
                    <div className="lg:w-3/5 text-center lg:text-left z-10">
                        <div className="inline-block px-4 py-2 bg-orange-100 text-[#f97416] rounded-full text-xs font-bold uppercase tracking-widest mb-6">
                       ...
                       <h2 className="text-3xl md:text-3xl font-extrabold mb-6 leading-tight text-neutral-900 dark:text-white">
                        ...
                        <span className="text-[#f97416]">In Your Pocket.</span>
                       </h2>
                        <p className="text-lg text-gray-600 dark:text-gray-400 mb-10 font-sans max-w-lg mx-auto lg:mx-0">
                            Get the <span className="font-bold text-[#f97416]">Chef Bazaar</span> app for real-time order tracking, direct chat with chefs, and exclusive loyalty rewards.
                        </p>
                    ...
                    <div className="lg:w-2/5 relative">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-[#f97416] rounded-full blur-[100px] opacity-20"></div>
                        ...
                        <div className="relative z-10 animate-float">
                            ...
                            <div className="absolute top-10 -right-10 bg-white dark:bg-base-200 p-4 rounded-2xl shadow-xl border border-base-200 hidden md:block">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-xs font-bold font-sans">Chef Maria is <br/> cooking!</p>
                                </div>
                            </div>
                            ...
                            <div className="absolute bottom-20 -left-12 bg-white dark:bg-base-200 p-4 rounded-2xl shadow-xl border border-base-200 hidden md:block">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 bg-orange-100 text-[#f97416] rounded-full flex items-center justify-center text-lg">★</div>
