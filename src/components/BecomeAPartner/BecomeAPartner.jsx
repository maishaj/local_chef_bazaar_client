...
const BecomeAPartner = () => {
  return (
    <div className="w-11/12 mx-auto">
      <section className="relative py-20 px-4 overflow-hidden bg-base-200">
        ...
        <div className="mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div className="w-full lg:w-1/2 relative">
              ...
              <div className="absolute -bottom-6 -left-6 w-2/3 h-2/3 bg-[#059669] rounded-3xl -z-0 opacity-20"></div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-3xl md:text-3xl font-bold mb-6 leading-tight">
                ...
                <span className="text-[#059669]">Business</span>
              </h2>

              <p className="text-lg text-base-content/70 mb-8 font-sans">
                Join our community of passionate home cooks. Share your secret
                family recipes, serve your neighbors, and build a brand—all from
              ...
              <ul className="space-y-4 mb-10 font-sans">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span className="font-medium">
                    Flexible hours—cook when you want
                  </span>
                </li>
                <li className="flex items-center gap-3">
                  <div className="p-1 bg-orange-100 rounded-full">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to="/about"
                  className="btn my-btn text-white btn-lg px-8 border-none shadow-lg shadow-orange-200"
                >
                  Learn More
                </Link>
              </div>
