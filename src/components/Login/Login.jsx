                ...
                <form onSubmit={handleSubmit(handleLogin)} className="card bg-base-100  max-w-sm shrink-0 shadow-2xl w-10/12 mx-auto">
                    <div className="card-body">
                        ...
                        <fieldset className="fieldset">
                            ...
                            <input type="password" className="input" {...register("password")} placeholder="Your password" />
                            {
                        ...
                        <button type="button" onClick={handleGoogle} className="btn bg-white text-black border-[#e5e5e5] w-full border-2">
