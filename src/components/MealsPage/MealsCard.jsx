      ...
      <div className="card-body p-5 flex flex-col justify-between">
        <div>
          <div className="flex justify-between items-start">
            <h2 className="card-title font-bold text-neutral-900 dark:text-white">
              {foodName}
            </h2>
            <span className="text-[#059669] font-bold">{foodPrice} TK</span>
          </div>
        ...
        <div className="mt-auto">
          ...
          <div className="card-actions justify-end">
            <Link
              ...
              className="btn btn-sm my-btn my-btn:hover  text-white border-none px-6"
            >
              Details
            </Link>
          </div>
