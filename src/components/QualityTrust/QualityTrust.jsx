  ...
  const features = [
    {
      ...
      desc: "Every chef undergoes a 5-step background and kitchen check.",
      icon: "✅",
    },
    {
      title: "Fresh Ingredients",
      desc: "Meals are made to order using locally sourced produce.",
      icon: "🌿",
    },
    {
      title: "Eco-Friendly",
      desc: "We encourage biodegradable packaging for all our home deliveries.",
      icon: "📦",
    },
  ];

  return (
    <div className="w-11/12 mx-auto py-15 bg-base-100">
      <div className="px-4">
        <div className="bg-orange-50 dark:bg-orange-950/10 rounded-3xl p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 border border-orange-100 dark:border-orange-900/30">
          <div className="md:w-1/2">
            <h2 className="text-4xl font-bold mb-6 text-neutral-900 dark:text-white">
              Why Trust <span className="text-[#059669]">Our Kitchens?</span>
            </h2>

            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 font-sans">
              We maintain the highest standards of hygiene and quality so you
              can enjoy home-cooked meals with peace of mind.
            </p>
