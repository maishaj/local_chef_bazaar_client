                ...
                <form onSubmit={handleSubmit(handleRegistration)} className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl border border-base-300">
                    <div className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input id="name" type="text" className="input input-bordered bg-base-200 focus:outline-none focus:border-emerald-500" placeholder="Your name" {...register("name", { required: true })} />
                        ...
                        <div className="form-control">
                            ...
                            <input id="email" type="email" className="input input-bordered bg-base-200 focus:outline-none focus:border-emerald-500" placeholder="Your email" {...register("email", { required: true })} />
                        ...
                        <div className="form-control">
                            ...
                            <input id="address" type="text" className="input input-bordered bg-base-200 focus:outline-none focus:border-emerald-500" placeholder="Your address" {...register("address", { required: true })} />
                        ...
                        <div className="form-control">
                            ...
                            <input id="pass" type="password" className="input input-bordered bg-base-200 focus:outline-none focus:border-emerald-500" placeholder="Your password" 
                                {...register("password", { 
                                    required: true, 
                                    minLength: 6, 
                        ...
                        <div className="form-control">
                            ...
                            <input id="confirm" type="password" className="input input-bordered bg-base-200 focus:outline-none focus:border-emerald-500" placeholder="Confirm your password" 
                        ...
                        <button className="btn bg-white text-black border-[#e5e5e5]" type="button" disabled={loading} onClick={googleSignIn} >
